...
<html>
<head>
<title>Edit <fmt:message key="user.title"/> <fmt:message key="answer.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveUserAnswers" method="POST" modelAttribute="answer">
