...
<html>
<head>
<title>Edit <fmt:message key="user.title"/> <fmt:message key="usercategory.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveUserUserCategories" method="POST" modelAttribute="usercategory">
