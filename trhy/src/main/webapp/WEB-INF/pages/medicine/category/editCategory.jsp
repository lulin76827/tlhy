...
<html>
<head>
<title>Edit <fmt:message key="medicine.title"/> <fmt:message key="category.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveMedicineCategory" method="POST" modelAttribute="category">
