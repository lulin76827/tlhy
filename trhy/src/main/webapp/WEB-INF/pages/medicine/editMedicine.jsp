...
<html>
<head>
<title>Edit <fmt:message key="medicine.title"/></title>
</head>
<body>
<div id="contentarea">      
			...
			<table cellpadding="0" cellspacing="0" id="viewTable">
				<tbody>
					...
					<tr>
						...
						<td>
							<form:select id="medicine_type" path="type" cssStyle="width:200px;" items="${medicineTypes }" itemLabel="label" itemValue="name"/>
						</td>
					</tr>
					<tr>
						<td class="label" valign="top">
						...
						<td>
							<form:select id="medicine_category" path="category.id" cssStyle="width:200px;" items="${categorys }" itemLabel="categoryField" itemValue="id"/>
						</td>
					</tr>
				</tbody>
			</table>
