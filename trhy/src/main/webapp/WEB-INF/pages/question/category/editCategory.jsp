...
<html>
<head>
<title>Edit <fmt:message key="question.title"/> <fmt:message key="category.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveQuestionCategory" method="POST" modelAttribute="category">
