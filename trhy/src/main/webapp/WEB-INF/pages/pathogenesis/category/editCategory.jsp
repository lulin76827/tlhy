...
<html>
<head>
<title>Edit <fmt:message key="pathogenesis.title"/> <fmt:message key="category.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/savePathogenesisCategory" method="POST" modelAttribute="category">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="pathogenesis_id" value="${pathogenesis_id}" >
