...
<html>
<head>
<title>Edit <fmt:message key="usercategory.title"/> <fmt:message key="user.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveUserCategoryUser" method="POST" modelAttribute="user">
