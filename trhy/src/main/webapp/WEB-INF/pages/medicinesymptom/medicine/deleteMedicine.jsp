...
<html>
<head>
<title>View <fmt:message key="medicinesymptom.title"/> <fmt:message key="medicine.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="brc"><div id="tb"><div id="tlc"><div id="trc">
		<div id="content">
			...
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/deleteMedicineSymptomMedicine?medicinesymptom_id=${medicinesymptom_id}&related_medicine_id=${medicine.id}&"><span><img src="images/icons/delete.gif" /><fmt:message key="navigation.delete"/></span></a></div>
			<div class="clear">&nbsp;</div>
		</div>
	</div></div></div></div>
	</div></div></div></div>
