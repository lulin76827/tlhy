...
<html>
<head>
<title>List <fmt:message key="medicinesymptom.title"/>s</title>
</head>
<body>
<div id="contentarea" >
	...
	<div id="content">
		<h1>Manage <fmt:message key="medicinesymptom.title"/>s</h1>
		<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/newMedicineSymptom"><span><img src="${pageContext.request.contextPath}/images/icons/new.gif" /><fmt:message key="navigation.new"/> <fmt:message key="medicinesymptom.title"/></span></a></div>
		<div id="tablewrapper">
		<table id="listTable" cellpadding="0" cellspacing="0">
			...
			<tbody>
				<c:forEach items="${medicinesymptoms}" var="current" varStatus="i">
					<c:choose>
