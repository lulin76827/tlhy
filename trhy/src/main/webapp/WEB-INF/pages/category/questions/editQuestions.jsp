...
<html>
<head>
<title>Edit <fmt:message key="category.title"/> <fmt:message key="question.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveCategoryQuestions" method="POST" modelAttribute="question">
