...
<html>
<head>
<title>Edit <fmt:message key="symptom.title"/> <fmt:message key="category.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveSymptomCategory" method="POST" modelAttribute="category">
