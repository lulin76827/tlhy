...
<html>
<head>
<title>Edit <fmt:message key="symptom.title"/> <fmt:message key="medicinesymptom.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveSymptomMedicineSymptoms" method="POST" modelAttribute="medicinesymptom">
