...
<html>
<head>
<title>Edit <fmt:message key="question.title"/> <fmt:message key="answer.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveQuestionAnswers" method="POST" modelAttribute="answer">
