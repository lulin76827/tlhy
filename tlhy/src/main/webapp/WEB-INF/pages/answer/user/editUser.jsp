...
<html>
<head>
<title>Edit <fmt:message key="answer.title"/> <fmt:message key="user.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveAnswerUser" method="POST" modelAttribute="user">
