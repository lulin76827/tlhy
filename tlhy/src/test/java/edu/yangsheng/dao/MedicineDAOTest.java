...
public class MedicineDAOTest {
	 ...
	 *
	 */
	private MedicineDAO dataStore;

	/**
	 * Instantiates a new MedicineDAOTest.
	 *
	 */
	public MedicineDAOTest() {
	}

	/**
	 * Method to test Medicine domain object.
	 *
	 */
	@Rollback(false)
	@Test
	 ...
	 */
	@Autowired
	public void setDataStore(MedicineDAO dataStore) {
